# World's Science & Technology History
...
https://en.wikipedia.org/wiki/History_of_science#See_also
- [2020s in science and technology](https://en.wikipedia.org/wiki/2020s_in_science_and_technology "2020s in science and technology")
...
- [History of astronomy](https://en.wikipedia.org/wiki/History_of_astronomy "History of astronomy")
- [History of biology](https://en.wikipedia.org/wiki/History_of_biology "History of biology")
- [History of chemistry](https://en.wikipedia.org/wiki/History_of_chemistry "History of chemistry")
- [History of Earth science](https://en.wikipedia.org/wiki/Outline_of_Earth_sciences#History_of_Earth_science "Outline of Earth sciences")
- [History of measurement](https://en.wikipedia.org/wiki/History_of_measurement "History of measurement")
- [History of physics](https://en.wikipedia.org/wiki/History_of_physics "History of physics")
- [History of scholarship](https://en.wikipedia.org/wiki/History_of_scholarship "History of scholarship")
...
- [History of the social sciences](https://en.wikipedia.org/wiki/History_of_the_social_sciences "History of the social sciences")
- [History of science policy](https://en.wikipedia.org/wiki/History_of_science_policy "History of science policy")
- [List of experiments](https://en.wikipedia.org/wiki/List_of_experiments "List of experiments")
- [List of multiple discoveries](https://en.wikipedia.org/wiki/List_of_multiple_discoveries "List of multiple discoveries")
- [List of Nobel laureates](https://en.wikipedia.org/wiki/List_of_Nobel_laureates "List of Nobel laureates")
- [List of scientists](https://en.wikipedia.org/wiki/Category:Scientific_societies "Category:Scientific societies")
- [List of years in science](https://en.wikipedia.org/wiki/List_of_years_in_science "List of years in science")
- [Materialism Controversy](https://en.wikipedia.org/wiki/Materialism_Controversy "Materialism Controversy")
- [Multiple discovery](https://en.wikipedia.org/wiki/Multiple_discovery "Multiple discovery")
- [Science tourism](https://en.wikipedia.org/wiki/Science_tourism "Science tourism")
- [Sociology of the history of science](https://en.wikipedia.org/wiki/Sociology_of_the_history_of_science "Sociology of the history of science")
- [Timelines of science](https://en.wikipedia.org/wiki/List_of_timelines#Science "List of timelines")
    - [Timeline of scientific discoveries](https://en.wikipedia.org/wiki/Timeline_of_scientific_discoveries "Timeline of scientific discoveries")
    - [Timeline of scientific experiments](https://en.wikipedia.org/wiki/Timeline_of_scientific_experiments "Timeline of scientific experiments")
    - [Timeline of the history of the scientific method](https://en.wikipedia.org/wiki/Timeline_of_the_history_of_the_scientific_method "Timeline of the history of the scientific method")
- [Yuasa Phenomenon](https://en.wikipedia.org/wiki/Yuasa_Phenomenon "Yuasa Phenomenon") – Migration of center of activity of world science
...
The **Age of Discovery** (c. 1418 – c. 1620), also known as the **Age of Exploration**, was part of the [early modern period](https://en.wikipedia.org/wiki/Early_modern_period "Early modern period") and overlapped with the [Age of Sail](https://en.wikipedia.org/wiki/Age_of_Sail "Age of Sail"). It was a period from approximately the 15th to the 17th century, during which [seafarers](https://en.wikipedia.org/wiki/Seamanship "Seamanship") from European countries explored, colonized, and conquered regions across the globe. The Age of Discovery was a transformative period when previously isolated parts of the world became connected to form the [world-system](https://en.wikipedia.org/wiki/World-system "World-system"), and laid the groundwork for [globalization](https://en.wikipedia.org/wiki/Globalization "Globalization"). The extensive overseas exploration, particularly the opening of maritime routes to the [East Indies](https://en.wikipedia.org/wiki/East_Indies "East Indies") and [European colonization of the Americas](https://en.wikipedia.org/wiki/European_colonization_of_the_Americas "European colonization of the Americas") by the [Spanish](https://en.wikipedia.org/wiki/Spanish_Empire "Spanish Empire") and [Portuguese](https://en.wikipedia.org/wiki/Portuguese_Empire "Portuguese Empire"), later joined by the [English](https://en.wikipedia.org/wiki/British_Empire "British Empire"), [French](https://en.wikipedia.org/wiki/French_colonial_empire "French colonial empire"), and [Dutch](https://en.wikipedia.org/wiki/Dutch_colonial_empire "Dutch colonial empire"), spurred [international global trade](https://en.wikipedia.org/wiki/International_trade "International trade"). The interconnected global economy of the 21st century has its origins in the expansion of trade networks during this era.

The exploration created [colonial empires](https://en.wikipedia.org/wiki/Colonial_empire "Colonial empire") and marked an increased adoption of [colonialism](https://en.wikipedia.org/wiki/Colonialism "Colonialism") as a government policy in several European states. As such, it is sometimes synonymous with the [first wave of European colonization](https://en.wikipedia.org/wiki/First_wave_of_European_colonization "First wave of European colonization"). This colonization reshaped power dynamics causing geopolitical shifts in Europe and creating new centers of power beyond Europe. Having set human history on the global common course, the legacy of the Age still shapes the world today.

European oceanic exploration started with the maritime expeditions of Portugal to the [Canary Islands](https://en.wikipedia.org/wiki/Canary_Islands "Canary Islands") in 1336, and with the [Portuguese discoveries](https://en.wikipedia.org/wiki/Portuguese_discoveries "Portuguese discoveries") of the Atlantic archipelagos of [Madeira](https://en.wikipedia.org/wiki/Madeira "Madeira") and [Azores](https://en.wikipedia.org/wiki/Azores "Azores"), the coast of [West Africa](https://en.wikipedia.org/wiki/West_Africa "West Africa") in 1434, and the [establishment of the sea route to India](https://en.wikipedia.org/wiki/Portuguese_discovery_of_the_sea_route_to_India "Portuguese discovery of the sea route to India") in 1498 by [Vasco da Gama](https://en.wikipedia.org/wiki/Vasco_da_Gama "Vasco da Gama"), which initiated the Portuguese maritime and trade presence in [Kerala](https://en.wikipedia.org/wiki/Kerala "Kerala") and the [Indian Ocean](https://en.wikipedia.org/wiki/Indian_Ocean "Indian Ocean"). Spain sponsored and financed the transatlantic [voyages of Christopher Columbus](https://en.wikipedia.org/wiki/Voyages_of_Christopher_Columbus "Voyages of Christopher Columbus") (1492–1504), which marked the beginning of colonization in the Americas, and the [Magellan expedition](https://en.wikipedia.org/wiki/Magellan_expedition "Magellan expedition") (1519–1522), which opened a route from the Atlantic to the Pacific and, under [Juan Sebastián Elcano](https://en.wikipedia.org/wiki/Juan_Sebasti%C3%A1n_Elcano "Juan Sebastián Elcano"), completed the first [circumnavigation](https://en.wikipedia.org/wiki/Circumnavigation "Circumnavigation") of the globe. These Spanish expeditions significantly impacted European perceptions of the world and eventually led to numerous naval expeditions across the Atlantic, Indian, and Pacific Oceans, and land expeditions in the Americas, Asia, Africa, and Australia that continued into the 19th century, followed by [Polar exploration](https://en.wikipedia.org/wiki/Polar_exploration "Polar exploration") in the 20th century.

European exploration initiated the [Columbian exchange](https://en.wikipedia.org/wiki/Columbian_exchange "Columbian exchange") between the [Old World](https://en.wikipedia.org/wiki/Old_World "Old World") (Europe, Asia, and Africa) and [New World](https://en.wikipedia.org/wiki/New_World "New World") (Americas). This exchange involved the transfer of plants, animals, human populations (including [slaves](https://en.wikipedia.org/wiki/Slavery "Slavery")), [communicable diseases](https://en.wikipedia.org/wiki/Infection "Infection"), and culture across the [Eastern](https://en.wikipedia.org/wiki/Eastern_Hemisphere "Eastern Hemisphere") and [Western Hemispheres](https://en.wikipedia.org/wiki/Western_Hemisphere "Western Hemisphere"). The Age of Discovery and [European exploration](https://en.wikipedia.org/wiki/Major_explorations_after_the_Age_of_Discovery "Major explorations after the Age of Discovery") involved [mapping the world](https://en.wikipedia.org/wiki/History_of_cartography "History of cartography"), shaping a new worldview and facilitating contact with distant civilizations. The continents drawn by European mapmakers developed from abstract "[blobs](https://en.wiktionary.org/wiki/blob "wikt:blob")" into the outlines more recognizable to us. Simultaneously, the spread of new diseases, especially [affecting native Americans](https://en.wikipedia.org/wiki/Native_American_disease_and_epidemics "Native American disease and epidemics"), led to [rapid declines in some populations](https://en.wikipedia.org/wiki/Population_history_of_the_Indigenous_peoples_of_the_Americas "Population history of the Indigenous peoples of the Americas"). The era saw widespread enslavement, exploitation and military conquest of [indigenous peoples](https://en.wikipedia.org/wiki/Indigenous_peoples "Indigenous peoples"), concurrent with the growing economic influence and spread of [Western culture](https://en.wikipedia.org/wiki/Western_culture "Western culture"), science and technology leading to a [faster-than-exponential population growth](https://en.wikipedia.org/wiki/Estimates_of_historical_world_population "Estimates of historical world population") world-wide.
...
> - [2. The Historical Context of the _Principia_](https://plato.stanford.edu/entries/newton-principia/#HisConPri)
> - [3. The Three Editions of the _Principia_](https://plato.stanford.edu/entries/newton-principia/#ThrEdiPri)
> - [4. “Definitions” and absolute space, time, and motion](https://plato.stanford.edu/entries/newton-principia/#DefAbsSpaTimMot)
> - [5. Newton's Laws of Motion](https://plato.stanford.edu/entries/newton-principia/#NewLawMot)
> - [6. Book 1 of the _Principia_](https://plato.stanford.edu/entries/newton-principia/#Boo1Pri)
> - [7. Book 2 of the _Principia_](https://plato.stanford.edu/entries/newton-principia/#Boo2Pri)
> - [8. Book 3 of the _Principia_](https://plato.stanford.edu/entries/newton-principia/#Boo3Pri)
> - [9. The Scientific Achievement of the _Principia_](https://plato.stanford.edu/entries/newton-principia/#SciAchPri)
> - [10. The Methodology of the _Principia_](https://plato.stanford.edu/entries/newton-principia/#MetPri)
> - [Bibliography](https://plato.stanford.edu/entries/newton-principia/#Bib)
> 	- [Primary Sources](https://plato.stanford.edu/entries/newton-principia/#PriSou)
> 	- [Secondary Sources](https://plato.stanford.edu/entries/newton-principia/#SecSou)
> - [Academic Tools](https://plato.stanford.edu/entries/newton-principia/#Aca)
> - [Other Internet Resources](https://plato.stanford.edu/entries/newton-principia/#Oth)
> - [Related Entries](https://plato.stanford.edu/entries/newton-principia/#Rel)
...
While the Enlightenment cannot be pigeonholed into a specific doctrine or set of dogmas, science came to play a leading role in Enlightenment discourse and thought. Many Enlightenment writers and thinkers had backgrounds in the sciences and associated scientific advancement with the overthrow of religion and traditional authority in favour of the development of free speech and thought. Broadly speaking, Enlightenment science greatly valued [empiricism](https://en.wikipedia.org/wiki/Empiricism "Empiricism") and rational thought, and was embedded with the Enlightenment ideal of advancement and progress. As with most Enlightenment views, the benefits of science were not seen universally; [Jean-Jacques Rousseau](https://en.wikipedia.org/wiki/Jean-Jacques_Rousseau "Jean-Jacques Rousseau") criticized the sciences for distancing man from nature and not operating to make people happier.

Science during the Enlightenment was dominated by scientific societies and [academies](https://en.wikipedia.org/wiki/Academy "Academy"), which had largely replaced universities as centres of scientific research and development. Societies and academies were also the backbone of the maturation of the scientific profession. Another important development was the [popularization](https://en.wikipedia.org/wiki/Popular_culture "Popular culture") of science among an increasingly literate population. [Philosophes](https://en.wikipedia.org/wiki/Philosophes "Philosophes") introduced the public to many scientific theories, most notably through the _[Encyclopédie](https://en.wikipedia.org/wiki/Encyclop%C3%A9die "Encyclopédie")_ and the popularization of [Newtonianism](https://en.wikipedia.org/wiki/Newtonianism "Newtonianism") by [Voltaire](https://en.wikipedia.org/wiki/Voltaire "Voltaire") as well as by Émilie du Châtelet, the French translator of Newton's _[Philosophiæ Naturalis Principia Mathematica](https://en.wikipedia.org/wiki/Philosophi%C3%A6_Naturalis_Principia_Mathematica "Philosophiæ Naturalis Principia Mathematica")_. Some historians have marked the 18th century as a drab period in the [history of science](https://en.wikipedia.org/wiki/History_of_science "History of science"); however, the century saw significant advancements in the practice of [medicine](https://en.wikipedia.org/wiki/Medicine "Medicine"), [mathematics](https://en.wikipedia.org/wiki/Mathematics "Mathematics"), and [physics](https://en.wikipedia.org/wiki/Physics "Physics"); the development of biological [taxonomy](https://en.wikipedia.org/wiki/Taxonomy_\(biology\) "Taxonomy (biology)"); a new understanding of [magnetism](https://en.wikipedia.org/wiki/Magnetism "Magnetism") and [electricity](https://en.wikipedia.org/wiki/Electricity "Electricity"); and the maturation of [chemistry](https://en.wikipedia.org/wiki/Chemistry "Chemistry") as a discipline, which established the foundations of modern chemistry.
...
The discovery of new types of radiation and the simultaneous revelation of the nature of atomic structure and matter are two additional highlights. In astronomy, the planet Neptune was discovered. In mathematics, the notion of complex numbers finally matured and led to a subsequent analytical theory; they also began the use of [hypercomplex numbers](https://en.wikipedia.org/wiki/Hypercomplex_number "Hypercomplex number"). [Karl Weierstrass](https://en.wikipedia.org/wiki/Karl_Weierstrass "Karl Weierstrass") and others carried out the [arithmetization of analysis](https://en.wikipedia.org/wiki/Arithmetization_of_analysis "Arithmetization of analysis") for functions of [real](https://en.wikipedia.org/wiki/Function_of_a_real_variable "Function of a real variable") and [complex variables](https://en.wikipedia.org/wiki/Complex_variable "Complex variable"). It also saw rise to [new progress in geometry](https://en.wikipedia.org/wiki/Non-Euclidean_geometry "Non-Euclidean geometry") beyond those classical theories of Euclid, after a period of nearly two thousand years. The mathematical science of logic likewise had revolutionary breakthroughs after a similarly long period of stagnation. But the most important step in science at this time were the ideas formulated by the creators of electrical science. Their work changed the face of physics and made possible for new technology to come about such as electric power, electrical telegraphy, the telephone, and radio.
...
[Science](https://en.wikipedia.org/wiki/Science "Science") advanced dramatically during the [20th century](https://en.wikipedia.org/wiki/20th_century "20th century"). There were new and radical developments in the [physical](https://en.wikipedia.org/wiki/Outline_of_physical_science "Outline of physical science"), [life](https://en.wikipedia.org/wiki/Life_sciences "Life sciences") and [human](https://en.wikipedia.org/wiki/Human_science "Human science") sciences, building on the progress made in the 19th century.

The development of post-Newtonian theories in physics, such as [special relativity](https://en.wikipedia.org/wiki/Special_relativity "Special relativity"), [general relativity](https://en.wikipedia.org/wiki/General_relativity "General relativity"), and [quantum mechanics](https://en.wikipedia.org/wiki/Quantum_mechanics "Quantum mechanics") led to the development of [nuclear weapons](https://en.wikipedia.org/wiki/Nuclear_weapons "Nuclear weapons"). New models of the structure of the atom led to developments in theories of chemistry and the development of new materials such as [nylon](https://en.wikipedia.org/wiki/Nylon "Nylon") and [plastics](https://en.wikipedia.org/wiki/Plastic "Plastic"). Advances in biology led to large increases in food production, as well as the elimination of diseases such as [polio](https://en.wikipedia.org/wiki/Polio "Polio").

A massive amount of new technologies were developed in the 20th century. Technologies such as [electricity](https://en.wikipedia.org/wiki/Electricity "Electricity"), the [incandescent light bulb](https://en.wikipedia.org/wiki/Incandescent_light_bulb "Incandescent light bulb"), the [automobile](https://en.wikipedia.org/wiki/Automobile "Automobile") and the [phonography](https://en.wikipedia.org/wiki/Phonograph "Phonograph"), first developed at the end of the 19th century, were perfected and universally deployed. The first [airplane](https://en.wikipedia.org/wiki/Airplane "Airplane") flight occurred in 1903, and by the end of the century large airplanes such as the [Boeing 777](https://en.wikipedia.org/wiki/Boeing_777 "Boeing 777") and [Airbus A330](https://en.wikipedia.org/wiki/Airbus_A330 "Airbus A330") flew thousands of miles in a matter of hours. The development of the [television](https://en.wikipedia.org/wiki/Television "Television") and [computers](https://en.wikipedia.org/wiki/Computers "Computers") caused massive changes in the dissemination of information.
...
↗ [The Internet Development (and Web Development)](../../../Information%20Science%20&%20Computer%20Science%20and%20Engineering/Software%20Engineering/☝️%20Application%20Software%20Engineering/🕸️%20The%20Internet%20Development%20%28and%20Web%20Development%29/The%20Internet%20Development%20%28and%20Web%20Development%29.md)
...
## Ref
[history of science | britania]: https://www.britannica.com/science/history-of-science
